...
abstract class $ForecastCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: 'weather_condition') Weather weather,
      int maxTemperature,
      int minTemperature});
}
...
class _$ForecastImpl implements _Forecast {
  const _$ForecastImpl(
      {@JsonKey(name: 'weather_condition') required this.weather,
  ...
  @override
  String toString() {
    return 'Forecast(weather: $weather, maxTemperature: $maxTemperature, minTemperature: $minTemperature)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, weather, maxTemperature, minTemperature);
...
abstract class _Forecast implements Forecast {
  const factory _Forecast(
      {@JsonKey(name: 'weather_condition') required final Weather weather,
      required final int maxTemperature,
      required final int minTemperature}) = _$ForecastImpl;
